...
class DataCheckError(SDKException, ValueError):
    """Received data packet check error."""


class DataLengthError(SDKException, ValueError):
    """Received data packet length error."""


class EncryptedDataCheckError(SDKException, ValueError):
    """Received encrypted data packet check error."""


class EncryptedDataLengthError(SDKException, ValueError):
...
BROADLINK_EXCEPTIONS = {
    ...
    -4007: (DataLengthError, "Received data packet length error"),
    -4008: (DataCheckError, "Received data packet check error"),
    -4010: (EncryptedDataLengthError, "Received encrypted data packet length error"),
    -4011: (EncryptedDataCheckError, "Received encrypted data packet check error"),
}
