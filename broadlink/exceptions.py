...
class DataCheckError(SDKException):
    """Received data packet check error."""


class DataLengthError(SDKException):
    """Received data packet length error."""


class EncryptedDataCheckError(SDKException):
    """Received encrypted data packet check error."""


class EncryptedDataLengthError(SDKException):
